    ...
    <div className="space-y-2">
      ...
      <div className="relative" ref={dropdownRef}>
        <div
          ...
          className="w-full px-3 py-2 border border-gray-200 dark:border-gray-800 rounded-md bg-white dark:bg-gray-950 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors flex items-center justify-between"
        >
          {selectedCourse ? (
                ...
                filteredCourses.map((course) => (
                  <div
                    ...
                    className={cn(
                      ...
                      value === course.sectionId?.toString() && "bg-gray-100 dark:bg-gray-800"
                    )}
                    onClick={() => {
